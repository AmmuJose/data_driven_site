 	<div class="<?php echo $left; ?>" > <!-- Left side -->	
		...
		<div class="pay_info_row"><label for="address1" class="log_info_label">*Address Line1:</label>
	...
	<div class="<?php echo $right; ?>" ><!--Right side -->
		...
		<div class="pay_info_row"><label for="address2" class="log_info_label">Address Line2:</label>
