<div class="pay_info_row "><label for="fname" class="log_info_label">*First Name:</label>
		...
		<input type="text" name="lname" id="lname" tabindex="<?php echo $ln; ?>" maxlength="30" size="20" 
		value="<?php if(isset($_POST['lname'])) echo $_POST['lname']; else{if(isset($row['lastname'])) echo $row['lastname'];} ?>" /></div>		
		
		<div class="pay_info_row "><label for="address1" class="log_info_label">*Address Line 1:</label>
		...
		<div class="pay_info_row "><label for="address2" class="log_info_label">Address Line 2:</label>
		...
		<div class="pay_info_row "><label for="city" class="log_info_label">*City:</label>
		...
		<div class="pay_info_row "><label for="state" class="log_info_label">*State:</label>
		<?php 
        ...
        <div class="pay_info_row "><label for="zipcode" class="log_info_label">*Zip Code:</label>
		...
		value="<?php if(isset($_POST['zipcode'])) echo $_POST['zipcode']; else{if(isset($row['zip'])) echo $row['zip'];} ?>"/></div>		
		 ...
		 <div class="pay_info_row "><label for="phone" class="log_info_label">*Phone:</label>
